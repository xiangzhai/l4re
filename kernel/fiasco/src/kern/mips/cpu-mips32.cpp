...
namespace Mips {
  ...
  template<> struct Cfg<0> : Cfg_base
  {
    ...
    static Cfg<0> read()
    { Mword v; __asm__ __volatile__ ("mfc0 %0, $16" : "=r"(v)); return v; }
  };
  ...
  template<> struct Cfg<1> : Cfg_base
  {
    ...
    static Cfg<1> read()
    { Mword v; __asm__ __volatile__ ("mfc0 %0, $16, 1" : "=r"(v)); return v; }
  };
  ...
  template<> struct Cfg<2> : Cfg_base
  {
    ...
    static Cfg<2> read()
    { Mword v; __asm__ __volatile__ ("mfc0 %0, $16, 2" : "=r"(v)); return v; }
  };
  ...
  template<> struct Cfg<3> : Cfg_base
  {
    ...
    static Cfg<3> read()
    { Mword v; __asm__ __volatile__ ("mfc0 %0, $16, 3" : "=r"(v)); return v; }
  };
  ...
  template<> struct Cfg<4> : Cfg_base
  {
    ...
    static Cfg<4> read()
    { Mword v; __asm__ __volatile__ ("mfc0 %0, $16, 4" : "=r"(v)); return v; }
  };
  ...
  template<> struct Cfg<5> : Cfg_base
  {
    ...
    static Cfg<5> read()
    { Mword v; __asm__ __volatile__ ("mfc0 %0, $16, 5" : "=r"(v)); return v; }
  };
      ...
      if (ftlb_info)
        {
          ...
          asm volatile ("mtc0 %0, $16, 4" : : "r"(c4._v));
          asm volatile ("ehb");
          asm volatile ("mfc0 %0, $16, 4" : "=r"(c4._v));
...
{
  Unsigned32 prid;
  asm volatile ("mfc0 %0, $15, 0" : "=r"(prid));
  ...
  if (options.segctl())
    {
      ...
      asm volatile ("mtc0 %0, $5, 2" : : "r"(0x00300010));
      // kseg1 kernel unmapped uncached, user mapped
      // kseg0 kernel unmapped cached, user mapped
      asm volatile ("mtc0 %0, $5, 3" : : "r"(0x00400042 | (cca << 16)));

      // cached and mapped in user mode
      asm volatile ("mtc0 %0, $5, 4" : : "r"(0x04300030 | (cca << 16) | cca));
      asm volatile ("ehb");
  ...
  asm volatile ("mtc0 %0, $7" : : "r"(hwrena)); //HWRena
}
