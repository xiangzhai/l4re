...
{
public:
  enum Phys_layout_rk3288_all : Address {
    Flush_area_phys_base = 0xe0000000,
  };
};

// ------------------------------------------------------------------------
INTERFACE [arm && (pf_rk3288_eb || pf_rk3288_pb11mp || pf_rk3288_pbx || pf_rk3288_vexpress_a9)]:
...
{
public:
  enum Phys_layout_rk3288 : Address {
...
// ------------------------------------------------------------------------
INTERFACE [arm && pf_rk3288_eb
           && !(arm_mpcore || arm_cortex_a9)]:

EXTENSION class Mem_layout
{
public:
  enum Phys_layout_rk3288_single : Address {
...
{
public:
  enum Phys_layout_rk3288_mp : Address {
...
// ------------------------------------------------------------------------
INTERFACE [arm && pf_rk3288_pb11mp]:

EXTENSION class Mem_layout
{
public:
  enum Phys_layout_rk3288_pb11mp : Address {
...
// ------------------------------------------------------------------------
INTERFACE [arm && pf_rk3288_pbx]:

EXTENSION class Mem_layout
{
public:
  enum Phys_layout_rk3288_pbx : Address {
    Devices1_phys_base    = 0x1f000000,
    Mp_scu_phys_base      = Devices1_phys_base,
    Gic_cpu_phys_base     = Devices1_phys_base + 0x00000100,
    Gic_dist_phys_base    = Devices1_phys_base + 0x00001000,
...
// ------------------------------------------------------------------------
INTERFACE [arm && rk3288_vexpress_legacy]:

EXTENSION class Mem_layout
{
public:
  enum Phys_layout_rk3288_vexpress_a9 : Address {
...
// ------------------------------------------------------------------------
INTERFACE [arm && pf_rk3288_vexpress && !rk3288_vexpress_legacy]:

EXTENSION class Mem_layout
{
public:
  enum Phys_layout_rk3288_vexpress_a15 {
